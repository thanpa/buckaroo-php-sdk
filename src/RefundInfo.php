...
class RefundInfo
{
    ...
    public function populate(stdClass $response): RefundInfo
    {
        $this
            ...
            ->setInvoiceAmount($response->InvoiceAmount)
            ->setInvoiceAmountPaid($response->InvoiceAmountPaid)
            ->setInvoiceAmountOpen($response->InvoiceAmountOpen)
            ->setCanCreateCreditNote($response->CanCreateCreditNote)
            ->setCreditNoteAmount($response->CreditNoteAmount)
